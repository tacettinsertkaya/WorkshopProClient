...
var RetroStartComponent = /** @class */ (function () {
    function RetroStartComponent(sharedService, authService, groupService, companyService, configService, router, retroHubService, userHubService, alertifyService, _ngZone, route) {
        this.sharedService = sharedService;
        this.authService = authService;
        this.groupService = groupService;
        this.companyService = companyService;
